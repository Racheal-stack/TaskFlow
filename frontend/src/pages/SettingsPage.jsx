...
import { Settings, User, Bell, Shield, Palette, Globe, HelpCircle, LogOut, ChevronRight, Moon, Sun, Monitor, Key, Mail, Send, CheckCircle } from 'lucide-react'
      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-gray-900 dark:text-white">TaskFlow Team</p>
                <p className="text-sm text-gray-600 dark:text-gray-400">5 members · Owner</p>
              </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg">
            <h4 className="font-medium text-gray-900 dark:text-white mb-4">Invite Team Members</h4>
