...
# Run the tests
echo "Running tests for Task 8..."
python3 -m pytest task/task-8/task_tests.py -v --tb=short
...
if [ $TEST_RESULT -eq 0 ]; then
    echo "✓ All tests passed for Task 8"
else
    echo "✗ Some tests failed for Task 8"
fi
echo "========================================="
