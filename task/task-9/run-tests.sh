...
# Run the tests
echo "Running tests for Task 9..."
python3 -m pytest task/task-9/task_tests.py -v --tb=short
...
if [ $TEST_RESULT -eq 0 ]; then
    echo "✓ All tests passed for Task 9"
else
    echo "✗ Some tests failed for Task 9"
fi
echo "========================================="
